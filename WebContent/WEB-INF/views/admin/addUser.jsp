...
<main role="main" id="content">
    <article class="post clearfix">
        <header>
            <h3 class="post-title">Ajout d'un utilisateur</h3>
        </header>
        <form method="post" action="createUser" id="form_sign">
            <fieldset>
                <legend>Informations</legend>
                <label for="email">Adresse mail</label>
                <br/>
                <input placeholder="Email" type="text" id="email" name="email"
                       value="<c:out value="${user.mailAddress}"/>" size="20" maxlength="60" required/>
                <br/>
                ...
                <input placeholder="Nom" type="text" id="name" name="name"
                       value="<c:out value="${user.name}"/>" size="20" maxlength="20" required/>
                <br/>
                ...
                <input placeholder="Prénom " type="text" id="firstname" name="firstname"
                       value="<c:out value="${user.firstname}"/>" size="20" maxlength="20" required/>
                <br/>
